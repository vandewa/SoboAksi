                                    ...
                                    <div class="donate-option">
                                        <div wire:loading>
                                            <div class="d-flex justify-content-center mb-3">
                                                <span class="badge badge-danger" style="font-size: 1.5em;">Mohon
                                                    Menunggu..</span>
                                            </div>
                                        </div>
                                        <h3>Berapa Banyak?</h3>
                                        <div class="donate-list">
                                            <div class="row mb-3 flex-container" style="width: 100%;">
                                                ...
                                                <div class="list-donasi mb-3" wire:click="tambahDonasi(100000)">100k
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group message-btn">
                                        <div class="tombol d-flex justify-content-center btn-block">
                                            <button type="submit" class="butt mb-2"
                                                style="line-height:25px !important;">Donasi</button>
                                        </div>
