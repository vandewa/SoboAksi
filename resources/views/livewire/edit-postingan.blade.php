                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    @else
                                        ...
                                        <img src="{{ route('helper.show-picture', ['path' => $photo2]) }}"
                                            width="200px" height="200px">
                                    @endif
                                    <input type="file" wire:model.lazy="photo" accept="image/*" class="form-control"
                                        name="name" placeholder="example name">
                                </div>
                                <div class="form-group">
                                    <label>Judul <span>*</span></label>
                                    <input type="text" wire:model.lazy="judul" class="form-control" name="name"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="" wire:model.lazy="kategori" class="form-control">
                                        @foreach ($listKategori ?? [] as $listKategori)
                                            <option value="{{ $listKategori->id }}">{{ $listKategori->nama_kategori }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            @if ($denganPenerima)
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="" class="form-control" wire:model.lazy="nama"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select wire:change="getKabupaten" name="" wire:model.lazy="region_prop"
                                            class="form-control">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="" wire:change="getKecamatan" wire:model.lazy="region_kab"
                                            class="form-control">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="" wire:change="getKelurahan" wire:model.lazy="region_kec"
                                            class="form-control">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" wire:model.lazy="telepon" name=""
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="" wire:model.lazy="no_identitas"
                                            class="form-control">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        @else
                                            ...
                                            <img src="{{ route('helper.show-picture', ['path' => $foto_penerima2]) }}"
                                                width="200px" height="200px">
                                        @endif
                                        <input type="file" name="" wire:model.lazy="foto_penerima"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" wire:model.lazy="target_waktu" name="name"
