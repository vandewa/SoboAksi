    ...
    <div class="d-none d-md-block">
        <div class="container" style="margin-bottom: 150px !important;margin-top:150px;">
            ...
            <div class="card mb-4" style="width: 100%;border-radius: 2%;">
                <div class="row no-gutters mt-3 ml-3 mr-3 mb-3">
                    <div class="col-4">
                        <img src="{{ $datanya->sampul->url_photo?? asset('trusthand/assets/images/resource/cause-1.jpg') }}" class="card-img" style="height:300px !important; object-fit:cover;background-repeat:no-repeat;background-position: center center !important;">
                    </div>
                    <div class="col-8">
                        <div class="ml-3">
                    ...
                    <div class="col-8 mt-2">
                        <div>
                            <button type="button" class="btn btn-outline-info" style="font-size:15px; width:70px;font-weight:200;line-height:1;" wire:click="$emitTo('donate-popup', 'tampilModal2',{{ $datanya->id }})">Edit
                            </button>
                        </div>
                    </div>
                    <div class="col-4 d-flex justify-content-end mt-2   ">
                        <a href="{{ route('detail-donasi',$datanya->id) }}">
                            <button type="button" class="btn btn-outline-success" style="font-size:15px; width:90px;font-weight:200;line-height:1;">Lihat</button>
                        </a>
                    </div>
                </div>
            </div>
