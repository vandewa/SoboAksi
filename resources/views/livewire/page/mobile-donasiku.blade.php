                ...
                <div class="row no-gutters mt-3 ml-3 mr-3 mb-3">
                    <div class="col-4">
                        <a href="{{ route('detail-donasi',$devan->aksi->id) }}">
                            <img src="{{ $devan->aksi->sampul->url_photo?? asset('trusthand/assets/images/resource/cause-1.jpg') }}" class="card-img" alt="...">
                        </a>
                    </div>
                    <div class="col-8">
                        <div class="ml-3">
                                    ...
                                    <div class="col-6">
                                        <h6>
                                            <span style="font-size: 9px;width:100%;float: left;" >
                                                <b> Rp. {{ number_format($devan->penerimaDonasi->donasi_tercapai??0,0,',','.') }}</b>
                                            </span>
                                    ...
                                    <div class="col-6">
                                        <h6>
                                            <span style="font-size: 9px;width:100%;float: right;">
                                                <b> Rp. {{ number_format($devan->penerimaDonasi->target_donasi??0,0,',','.') }}</b>
                                            </span>
                    ...
                    <div class="col-8">
                        ...
                        @if ($days >=48)
                        <span style="font-size: 13px;">Status Pembayaran <span class="badge badge-danger">Expired</span></span>
                        @endif
                        @else
                        <span style="font-size: 10px;"><b>Kamu telah berdonasi</b>
                            <span style="font-size: 10px;color:green;">Rp. {{ number_format($devan->payment??0,0,',','.') }}</span>
                        </span>
                        @endif     
                    </div>
                    <div class="col-4 d-flex justify-content-end">
                        ...
                        @else
                            <a href="{{ $devan->url_payment }}">
                                <button type="button" class="btn btn-outline-danger" style="font-size:10px; width:90px;font-weight:200;line-height:1;">Bayar Sekarang</button>
                            </a>
                        @endif
                                
                        @else
                            <button type="button" class="btn btn-outline-success" style="font-size:10px; width:90px;font-weight:200;line-height:1;" wire:click="$emitTo('donate-form', 'tampilModal', {{ $devan->aksi->id }})">Donasi lagi</button>
                        @endif     
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="card mb-3" style="border-radius: 2%;width:800px;">
                    <div class="row no-gutters mt-3 ml-3 mr-3 mb-3">
                        <div class="col-4">
                            <a href="{{ route('detail-donasi',$devan->aksi->id) }}">
                                <img src="{{ $devan->aksi->sampul->url_photo?? asset('trusthand/assets/images/resource/cause-1.jpg') }}" class="card-img" style="width: 80%;">
                            </a>
                        </div>
                        <div class="col-8">
                            <div class="ml-3">
                                <a href="{{ route('detail-donasi',$devan->aksi->id) }}">
                                <p style="font-size: 20px;line-height: 17px"><b>{{ $devan->aksi->judul }}</b></p>
                                </a>
                        ...
                        <div class="col-8">
                            @if ($devan->payment_status == 'PENDING')
                            @if ($days >=48)
                            <span style="font-size: 16px;">Status Pembayaran <span class="badge badge-danger">Expired</span></span>
                            @endif
                            @else
                            <span style="font-size: 10px;"><b>Kamu telah berdonasi</b>
                                <span style="font-size: 10px;color:green;">Rp. {{ number_format($devan->payment??0,0,',','.') }}</span>
