...
<div class="auto-container d-none d-md-block">
    <div class="sec-title centred mb_50">
        <span class="sub-title">Cerita Diaspora</span>
    ...
    <div class="row clearfix mb-5">
                        ...
                        <div class="lower-content">
                            ...
                            <div class="text" style="height:100px;">
                                <h2 style="font-size: 17px !important;">
                                    <a href="{{ route('detail-donasi', $aksi->id) }}" style=" color:black; ">
                                        @if (strlen($aksi->judul) > 50)
                                            {{ substr($aksi->judul, 0, 50) }}..
                                        @else
                                            {{ substr($aksi->judul, 0, 50) }}
                                        @endif
                                    </a>
                            ...
                            <div class="progress-box" style="padding:10px 20px 26px;">
                                @if (Auth::check())
                                    @if ($aksi->dukung_count == 1)
                                        @if ($aksi->dukunganSaya)
                                            <span style="font-size: 11px;" class="ml-2"><b>Kamu</b> mendukung aksi
                                                ini</span>
                                        @else
                                            <span style="font-size: 11px;" class="ml-2"><b>{{ $aksi->dukung_count }}
                                ...
                                @else
                                    @if ($aksi->dukunganSaya)
                                        <span style="font-size: 9px;" class="ml-2">
                                            <b>Kamu</b> dan <b>{{ $aksi->dukung_count - 1 }} orang</b> mendukung aksi
                                            ini
                                        </span>
                                    @else
                                        <span style="font-size: 11px;" class="ml-2"><b>{{ $aksi->dukung_count }}
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-6">
                                        <div class="ml-1">
                                            <a href="{{ route('detail-donasi', $aksi->id) }}">
                                                <span style="font-size: 12px;color:black;"><i class="fas fa-eye"
        ...
        <div class="text-right col-md-12 d-flex justify-content-end mt-5">
            <div class="d-flex justify-content-end ml-6">
                <a class="btn btn-primary btn-md" href="{{ route('web-list-aksi') }}">Lihat Selengkapnya <i
