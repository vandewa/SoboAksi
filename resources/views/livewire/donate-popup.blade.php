                        ...
                        <div class="col-md-12">
                            ...
                            <h3>Penerima Donasi</h3>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="" class="form-control" id="" wire:model.lazy="nama" style="height:35px !important;" required>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" wire:model.lazy="telepon" name="" id="" class="form-control">
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="" wire:model.lazy="no_identitas" id="" class="form-control">
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12 push-right">
                                    <button type="submit" class="theme-btn-one btn-block mb-2" style="line-height:11px !important;">Beraksi</button>
                                </div>
                            </div>
                        </div>
                    </div>
