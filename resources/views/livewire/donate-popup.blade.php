                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    @endif
                                    @if ($isEdit)
                                    <input type="file" wire:model.lazy="photo" accept="image/png, image/jpeg" class="form-control" name="name" placeholder="example name">
                                    @else
                                ...
                                <div class="form-group">
                                    ...
                                    <select name=""  wire:model.lazy="kategori" class="form-control">
                                        @foreach ($listKategori??[] as $listKategori)
                                            <option value="{{ $listKategori->id }}" wire:key="select-kategori-{{ $listKategori->id }}">{{ $listKategori->nama_kategori }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
