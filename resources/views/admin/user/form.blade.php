            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        @else
                        {!! Form::select('roles[]', $roles,$userRole, array('class' => 'select2
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {{Form::select('jenis_kelamin_st', get_code_group('JENIS_KELAMIN_ST'), null, ['class' =>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {{Form::select('pekerjaan_st', get_code_group('PEKERJAAN_ST'), null, ['class' => 'form-control
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {{Form::select('region_prop', get_prov(), null, ['class' => 'form-control select2',
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        @if(Request::segment(3) == 'create' )
                        {{Form::select('region_kab', [], null, ['class' => 'form-control select2', 'placeholder' =>
                        'Pilih Kabupaten','id' => 'kabupaten'])}}
                        @else
                        {{Form::select('region_kab', get_kab($data->region_prop), $kabupaten, ['class' => 'form-control
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        @if(Request::segment(3) == 'create' )
                        {{Form::select('region_kec',[], null, ['class' => 'form-control select2', 'placeholder' =>
                        'Pilih Kecamatan', 'id' => 'kecamatan'])}}
                        @else
                        {{Form::select('region_kec', get_kec($data->region_kab), $kecamatan, ['class' => 'form-control
