...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">Tambah Wilayah</h3>
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('admin/wilayah') }}">Data wilayah</a>
                    </li>
                    <li class="breadcrumb-item"><a href="{{ url('admin/wilayah') }}">Management Wilayah</a>
                    </li>
                    <li class="breadcrumb-item active">Tambah Wilayah
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="horz-layout-colored-controls">Tambah Wilayah</h4>
