@section('title', 'Tambah Role Sobo Aksi')
@extends('layouts.utama')

@section('content')
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">Tambah Role</h3>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="horz-layout-colored-controls">Tambah Role</h4>
                    <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                </div>
                <div class="card-content collpase show">
                    <div class="card-body">
                        {{Form::open(['route' => 'admin:role.store','method' => 'post', 'id' => 'my-form'])}} 
...
@push('js')
{!! JsValidator::formRequest('App\Http\Requests\StoreRoleValidation','#my-form') !!}
 <script>
    function change()
     {
