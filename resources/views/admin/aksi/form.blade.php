<div class="form-body">
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        @if (Request::segment(4) == 'edit')
                            <img id="preview-image-before-upload2"
                                src="{{ route('helper.show-picture', ['path' => $data->sampul->path]) }}"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('kategori', $kategori, null, [
            ...
            @if (
                (Request::segment(2) == 'donasi' && Request::segment(3) == 'create') ||
                    (Request::segment(2) == 'donasi' && Request::segment(4) == 'edit'))
                @if (empty($data))
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Penerima</label>
                                {!! Form::select('penerima_id', $penerima, null, [
                                    'class' => 'form-control select2',
                    ...
                    <div class="row ">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::select('highlight', ['1' => 'Ya', '0' => 'Tidak'], null, [
                                    'class' => 'form-control',
                ...
                @else
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Penerima</label>
                                {!! Form::select('penerima_id', $penerima, $data->penerimaDonasi->penerima_id, [
                                    'class' => 'form-control select2',
                                    'placeholder' => '- Pilih Penerima -',
                                ]) !!}
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('setuju', ['1' => 'Disetujui', '0' => 'Ditolak'], null, [
                                'class' => 'form-control',
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('publish_st', get_code_group('PUBLISH_ST'), null, [
                                'class' => 'form-control',
